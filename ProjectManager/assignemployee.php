...
<?php
    ...
    while ($row = $statement->fetch()) {
        ...
        $sql1 = "INSERT INTO EmployeeProject (ProjectID, EmployeeID) VALUES (?, ?)";
...
<div class="px-4 py-5 my-5 text-center">
    ...
    <div style="margin: 20px">
      <?php
        ...
        $sql2 = "SELECT FirstName, LastName, EmployeeID, DepartmentID FROM Employee";
        $statement = $pdo->query($sql2);

        while ($row = $statement->fetch()) {
          $sql3 = "SELECT DepartmentName FROM Department WHERE DepartmentID = $row[DepartmentID] ";
          $statement1 = $pdo->query($sql3);
