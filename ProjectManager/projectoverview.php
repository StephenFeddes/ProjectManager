  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark" aria-label="Fifth navbar example">
    ...
    <div class="px-4 py-5 my-5 text-center">
        ...
        <?php
            ...
            $sql1 = "SELECT ProjectID, PatronCompanyName, Budget, DueDate FROM Project WHERE ProjectName = ?";
            ...
            /* Because we need to reference ProjectID rather than
            ProjectName, we set ProjectName to ProjectID*/
            $data["ProjectName"] = $row1["ProjectID"];

            $sql2 = "SELECT FirstName, LastName, E.EmployeeID, DepartmentName
                FROM Employee AS E
            ...
            $statement2->bindValue(1, $data["ProjectName"]); // ProjectName is ProjectID
            $statement2->execute();

            // This code will not run if the user has not entered a project name
            // Echo the projects employee/department info
            while ($row2 = $statement2->fetch() AND $data["ProjectName"] != "") {
