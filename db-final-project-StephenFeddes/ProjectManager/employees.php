...
<div class="px-4 py-5 my-5 text-center">
    ...
    <div style="margin: 20px">
      <?php
        ...
        $sql1 = "SELECT FirstName, LastName, EmailAddress, EmployeeID, DepartmentID FROM Employee";
        $statement = $pdo->query($sql1);

        // Echo each employee's info and department name
        while ($row = $statement->fetch()) {
          $sql2 = "SELECT DepartmentName FROM Department WHERE DepartmentID = $row[DepartmentID] ";
